...
DrumData::DrumData(): KickSound(nullptr), SnareSound(nullptr), HiHatClosedSound(nullptr), HiHatOpenSound(nullptr),
                      ClapSound(nullptr)
{
}
                                                                         ...
                                                                         ClapSound(nullptr)
{
	...
	Samba.HiHatClosed = FInstrumentSchedule(
		EQuartzCommandQuantization::SixteenthNote,
		{
			FPerBarSchedule(HiHatClosedSound, {
				                1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f,
	...
	SixteenthGroove.HiHatClosed = FInstrumentSchedule(
		...
		{
			FPerBarSchedule(HiHatClosedSound, {
				                1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f, 13.0, 14.0f,
				                15.0f, 16.0
			                }),
		}
	);
